...
class FlexmailAPI_Group extends FlexmailAPI implements FlexmailAPIServiceInterface
{
     ...
     *          "emailAddressFlexmailId"  => 31655,       // int mandatory
     * (unless referenceId is set)
     *          "emailAddressReferenceId" => "my-ref-001" // string mandatory
     * (unless flexmailId is set)
     *      )
     * );
     *
     * @param Array $parameters Associative array with properties of a
     *   groupSubscriptionType object
     *
