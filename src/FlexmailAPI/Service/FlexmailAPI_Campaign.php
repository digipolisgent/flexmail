...
class FlexmailAPI_Campaign extends FlexmailAPI implements FlexmailAPIServiceInterface
{
     ...
     *  $parameters = array (
     *      "campaignType" => array(
     *          "campaignName"               => "Test Campaigns", // string
     * mandatory
     *          "campaignSubject"            => "Test subject",   // string
     * mandatory
     *          "campaignSenderName"         => "Flexmail",       // string
     * mandatory
     *          "campaignMessageId"          => 207375,           // int
     * mandatory
     *          "campaignMailingIds"         => array(116911),    // array of
     * int. mandatory
     *          "campaignReplyEmailAddress"  => bar@flexmail.eu", // string
     * mandatory
     *          "campaignSenderEmailAddress" => foo@flexmail.eu", // string
     * mandatory
     *      )
     *  );
     *
     * @param  Array $parameters Ass. array with properties of a campaignType
     *   object
     *
     * @return campaignId
     */
     ...
     *  $parameters = array (
     *      "campaignType" => array(
     *          "campaignId"                 => 300125             // int
     * mandatory
     *          "campaignName"               => "Test Updated",    // string
     * optional
     *          "campaignSubject"            => "Test Update",     // string
     * optional
     *          "campaignSenderName"         => "Flexmail",        // string
     * optional
     *          "campaignMessageId"          => 207375,            // int
     ...
     *  );
     *
     * @param  Array $parameters Ass. array with properties of an campaignType
     *   object
     *
     * @return void
     */
     ...
     *          "testCampaignName"               => "Test Campaigns",  // string
     * mandatory
     *          "testCampaignSubject"            => "Test subject",    // string
     * mandatory
     *          "testCampaignSenderEmailAddress" => "foo@flexmail.eu", // string
     * mandatory
     *          "testCampaignSenderName"         => "Flexmail",        // string
     * mandatory
     *          "testCampaignReplyEmailAddress"  => "bar@flexmail.eu", // string
     * mandatory
     *          "testCampaignMessageId"          => 207375,            // int
     * mandatory
     *          "testCampaignSendToEmailAddress" => "foo@flexmail.eu"  // string
     * mandatory
     *      )
     *  );
     *
     * @param  Array $parameters Ass. array with properties of an
     *   TestCampaignType object
     *
     * @return void
     */
    ...
    /**
     * Request complete or partial history for all email addresses in a
     * campaign
     *
     * Parmeters example:
     * ------------------
     * $parameters = array (
     *      "campaignId"             => 12345,                 // int mandatory
     *      "timestampFrom"          => "2008-09-20T09:00:00", // string
     * optional
     *      "timestampTill"          => "2013-09-20T09:00:00", // string
     * optional
     *      "campaignHistoryOptions" => array (                // array
     * optional
     *          "campaignSend"              => true,           // boolean
     * optional
     *          "campaignRead"              => true,           // boolean
     * optional
     *          "campaignReadOnline"        => true,           // boolean
     * optional
     *          "campaignLinkClicked"       => true,           // boolean
     * optional
     *          "campaignLinkGroupClicked"  => true,           // boolean
     * optional
     *          "campaignReadInfoPage"      => true,           // boolean
     * optional
     *          "campaignFormVisited"       => true,           // boolean
     * optional
     *          "campaignFormSubmitted"     => true,           // boolean
     * optional
     *          "campaignFormSubmitted"     => true,           // boolean
     * optional
     *          "campaignSurveySubmitted"   => true,           // boolean
     * optional
     *          "campaignForwardSubmitted"  => true,           // boolean
     * optional
     *          "campaignForwardVisited"    => true            // boolean
     * optional
     *      ),
     *      "sort"                   => 0                      // integer
     * optional
     ...
     *
     *
     * @param  Array $parameters Ass. array with campaignId, optional
     *   TimeStampFrom, TimeStampTill and sort parameters and optional array
     *   with properties for campaignHistoryOptionsType object
     *
