...
class FlexmailAPI_Contact extends FlexmailAPI implements FlexmailAPIServiceInterface
{
     ...
     *      "emailAddressType"      =>  array(                // array
     * mandatory
     *          "emailAddress"      =>  "foobar@flexmail.eu", // string
     * mandatory
     *          "title"             =>  "Mister"              // string
     * optional
     ...
     *          "flexmailId"        => "1245887"             // int mandory
     * (unless referenceId set)
     *          "referenceId"       => "my-ref-001"          // string mandatory
     * (unless flexmailId set)
     ...
     *      "mailingListId"         => 116911,      // int mandatory
     *      "emailAddressType"      => array(       // array mandatory
     *          "flexmailId"        => "1245887"    // int mandory (unless
     * referenceId set)
     *          "referenceId"       => "my-ref-001" // string mandatory (unless
     * flexmailId set)
     *     )
     * );
     *
     * @param  Array $parameters Associative array with properties of an
     *   emailAddressType object and mailingListId
     *
     * @return void
     */
     ...
     * ------------------
     * $parameters = array (
     *      "mailingListIds" => array (             // array (of Int
     * (mailingListIds)) optional
     *          102545,
     *          102246
     *      ),
     *      "groupIds" => array (                   // array (of Int (groupIds))
     * optional
     *          4566,
     *          4456
     *      ),
     *      "emailAddressTypeItems" => array (      // array (of
     * EmailAddressType) optional array (
     ...
     * );
     *
     * @param  Array $parameters Array with Associative arrays with
     *   emailAddressTypeItems to import and mailingListId to import them to
     *
        ...
        foreach ($parameters as $key => $value):
            if ($key == "emailAddressTypeItems"):
                foreach ($value as $emailAddressType):
                    array_push($emailAddressTypeItems,
     ...
     * string
     * mandatory
     *      "timestampFrom"                  => "2008-09-02T14:42:30", //
     * string
     * (YYYY-MM-DDTHH:ii:ss) optional
     *      "timestampTill"                  => "2014-09-02T14:42:30", //
     * string
     * (YYYY-MM-DDTHH:ii:ss) optional
     *      "emailAddressHistoryOptionsType" => array (                // array
     * optional
     *          "created"                     => true,                 //
     * boolean optional
     *          "deleted"                     => true,                 //
     * boolean optional
     *          "profileUpdateVisited"        => true,                 //
     * boolean optional
     *          "profileUpdateSubmitted"      => true,                 //
     * boolean optional
     *          "subscribed"                  => true,                 //
     * boolean optional
     *          "unsubscribed"                => true,                 //
     ...
     * boolean optional
     *          "addedToAccountBlackList"     => true,                 //
     * boolean optional
     *          "removedFromAccountBlackList" => true,                 //
     * boolean optional
     *          "bounced"                     => true,                 //
     * boolean optional
     *          "bouncedOut"                  => true,                 //
     ...
     *          "campaignRead"                => true,                 //
     * boolean optional
     *          "campaignReadOnline"          => true,                 //
     * boolean optional
     *          "campaignLinkClicked"         => true,                 //
     * boolean optional
     *          "campaignLinkGroupClicked"    => true,                 //
     * boolean optional
     *          "campaignReadInfopage"        => true,                 //
     * boolean optional
     *          "campaignFormVisited"         => true,                 //
     * boolean optional
     *          "campaignFormSubmitted"       => true,                 //
     * boolean optional
     *          "campaignSurveyVisi ted"       => true,                 //
     * boolean optional
     *          "campaignSurveySubmitted"     => true,                 //
     * boolean optional
     *          "campaignForwardVisited"      => true,                 //
     * boolean optional
     *          "campaignForwardSubmitted"    => true,                 //
     * boolean optional
     *      )
     *      "sort"                           =>  1 // int optional (0 = asc, 1
     * =
     * desc)
     * );
     *
     * @param Array $parameters Associative arrays with emailAddress and
     *   optional timestampTill- and from, sort and
